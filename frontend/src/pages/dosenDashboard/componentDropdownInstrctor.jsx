...
const ComponentDropdownInstructor = ({ onAddInstructor }) => {
  ...
  useEffect(() => {
    const fetchInstructors = async () => {
      try {
        ...
        const filteredInstructors = instructorData.filter((user) => user.role === 1);
  ...
  return (
    <div className="relative">
      ...
      >
        Pilih Instruktur
        <svg className={`w-2.5 h-2.5 ms-3 transform transition-transform ${isDropdownOpen ? "rotate-180" : ""}`} aria-hidden="true" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li key={index} className="hover:bg-gray-100">
                <div className="flex justify-between items-center p-2">
                  <div className="flex items-center">
                    <img className="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={instructor.imageUrl || DEFAULT_IMAGE} alt={instructor.name} />
                    <div className="ml-2">

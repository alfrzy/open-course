      ...
      <section className="w-full lg:w-4/5">
        ...
        <div className="my-4">
          ...
          <input
            ...
            className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
            placeholder="Hal yang dipelajari"
          />
          <button
        ...
        <section className="rounded-md mb-4">
          <h1 className="font-bold mb-4">
            Anggota Instruktur / Dosen Pengajar
          </h1>
          <ComponentDropdownInstructor
            instructors={instructors.filter(
              (instructor) =>
                !addedInstructors.some(
                  (addedInstructor) => addedInstructor.name === instructor.name
                )
            )}
        ...
        <section>
          ...
          <div
            className={`border-2 border-blue-500 rounded-md p-3 mt-2 ${
              isBabMenuOpen ? "pb-4" : ""
            }`}
          >
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <button onClick={toggleBabMenu}>
                  {isBabMenuOpen ? (
                    <BiChevronDown className="text-lg mr-2" />
                  ) : (
                    <BiChevronRight className="text-lg mr-2" />
                  )}
                </button>
                <h1>Pengumuman</h1>
              </div>
        ...
        <div className="my-3">
          <button
            className=" py-[6px] px-[20px] text-white font-bold rounded hover:bg-opacity-50 transition-all duration-150 bg-blue-500"
            onClick={handleAddBabClick}
          >
            Tambah bab
          </button>
        </div>

      ...
      <section className="bg-gray-50 font-poppins">
        <div className="container py-5 px-5 md:px-10">
          <div className="flex flex-col items-center ">
            <h1 className="font-bold text-xl md:text-5xl md:mt-5 md:text-center">Bangun Keterampilan Anda</h1>
            <p className="text-center text-sm md:text-base py-5">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla, eligendi!, <br /> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates, praesentium!
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {Array.from({ length: 6 }).map((_, idx) => (
                <a href="#" key={idx} className="flex flex-col items-center justify-center p-5 bg-amber-100 border rounded shadow hover:bg-amber-300 transition duration-300 ease-in-out">
                  ...
                  <p className="font-normal text-sm text-gray-700 mt-2 text-center">Et omnia in potestate</p>
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center p-6 gap-4">
            ...
            <div className="mt-4 text-center md:text-right">
              ...
              <p className="mt-2 ">Et omnia in potestate nostra esse natura liber, libera, libere valeant; sed illis non est in nostra.</p>
            </div>
          </div>
          ...
          <div className="bg-blue-200 p-6 flex justify-center md:justify-start">
            <div className="flex flex-col w-full ">
              <label htmlFor="email" className="block mb-4 text-lg font-semibold text-center md:text-left">
                Tulis Email Anda untuk Mendapat Informasi Kelas Terbaru dari Kami
              </label>
              <div className="flex items-center max-w-xl space-x-2">
                <input type="email" id="email" className="bg-white border border-gray-400 text-gray-900 text-sm rounded-l-lg focus:ring-gray-500 focus:border-gray-500 w-full p-3" placeholder="Tuliskan email Anda" required />
                <button className="bg-green-500 text-white font-semibold p-3 px-6 rounded-r-lg hover:bg-green-600 transition" type="submit">
                  Subscribe
                </button>
              </div>
            </div>
